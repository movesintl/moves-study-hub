    ...
    <section className="py-20 px-4 md:px-6 lg:px-8 relative overflow-hidden" style={{ backgroundColor: '#f5f5f5' }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center w-fit leading-tight bg-gradient-to-r from-orange-100 to-orange-200 text-orange-600 px-6 py-3 rounded-full text-sm font-semibold mb-6 shadow-sm border border-orange-200">
