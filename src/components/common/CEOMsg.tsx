      ...
      <div className="relative w-[600px] h-[400px]">
        ...
        <div className="max-w-[292px]  flex flex-col gap-[18px] px-[30px] py-[15px] bg-white shadow-[0_20px_40px_-15px_rgba(2,48,71,0.06)] rounded-2xl absolute right-0 bottom-[28px]">
          <div className="space-y-2">
            <h4 className="text-xl font-bold text-primary">Shakil Shikdar</h4>
            <p className="text-sm text-gray-600">CEO at Moves International</p>
          </div>
          
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <Phone className="h-5 w-5 text-orange-500" />
              <span className="text-sm text-gray-600">+61 434 051 189</span>
            </div>
            
            <div className="flex items-center gap-2">
              <Mail className="h-5 w-5 text-orange-500" />
              <span className="text-sm text-gray-600">shakil@mieducation.com.au</span>
            </div>
          </div>
        </div>
      </div>
