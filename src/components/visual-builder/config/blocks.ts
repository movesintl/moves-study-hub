  ...
  // ====== COMPONENTS ======
  {
    ...
    content: `
      <div class="flex flex-wrap gap-4">
        <button class="px-6 py-3 bg-primary text-primary-foreground font-medium rounded-lg hover:bg-primary/90 transition-colors shadow-elegant hover:shadow-brand">
          Primary Button
        </button>
