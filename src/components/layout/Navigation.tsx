...
const Navigation = () => {
  ...
  const secondaryMenuItems = [
    ...
    { 
      name: 'Find Us', 
      submenu: [
        { name: 'Bangladesh Office', path: 'https://www.movesinternational.com.bd', external: true },
        { name: 'Australian Office', path: 'https://www.movesinternational.com.au', external: true }
      ]
    },
  ];
